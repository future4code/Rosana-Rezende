...
if (operation === 'getPost') {
    ...
    const post1 = axios_1.default.get(`${baseUrl}/${postNumber}`);
    const post2 = axios_1.default.get(`${baseUrl}/${postNumber2}`);
    const post3 = axios_1.default.get(`${baseUrl}/${postNumber3}`);
