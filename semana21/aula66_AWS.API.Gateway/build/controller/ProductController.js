...
var ProductController = /** @class */ (function () {
    ...
    ProductController.prototype.createProduct = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, name, image, price, err_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = req.body, name = _a.name, image = _a.image, price = _a.price;
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, ProductController.ProductBusiness.createProduct(name, image, price)];
                    case 2:
                        _b.sent();
